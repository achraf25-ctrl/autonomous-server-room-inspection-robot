...
static const _AnomalyEvent_type_support_symbol_names_t _AnomalyEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, inspection_bot_msgs, msg, AnomalyEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, inspection_bot_msgs, msg, AnomalyEvent)),
  }
};
...
{
  return &::inspection_bot_msgs::msg::rosidl_typesupport_cpp::AnomalyEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, inspection_bot_msgs, msg, AnomalyEvent)() {
  return get_message_type_support_handle<inspection_bot_msgs::msg::AnomalyEvent>();
}
