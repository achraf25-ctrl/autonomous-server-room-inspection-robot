...
: ${AMENT_CURRENT_PREFIX:="/media/sf_inspection_bot_ws/src/install/inspection_bot_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/inspection_bot_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/inspection_bot_description/environment/path.sh"
